...
export default class NewPointPresenter {
  ...
  init =(callback, allOffers, allPoints, isCancelButton) =>{
    ...
    this.#pointEditFormComponent = new PointEditFormView(defaultPoint, this.#allOffers, this.#allPoints, this.#isCancelButton);
